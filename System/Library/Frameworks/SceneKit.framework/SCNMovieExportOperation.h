...
-(void)renderAndAppendWithPresentationTime:(SCD_Struct_SC153)arg1 usingAdaptor:(id)arg2 metalTextureCache:(CVMetalTextureCacheRef)arg3 cvQueue:(id)arg4 completionBlock:(/*^block*/id)arg5 ;
-(void)appendImage:(CGImageRef)arg1 withPresentationTime:(SCD_Struct_SC153)arg2 usingAdaptor:(id)arg3 ;
