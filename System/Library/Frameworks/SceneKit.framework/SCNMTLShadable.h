...
-(void)setResource:(id)arg1 ofType:(unsigned long long)arg2 atIndices:(SCD_Struct_SC56)arg3 ;
-(id)bufferAtIndices:(SCD_Struct_SC56)arg1 ;
-(id)textureAtIndices:(SCD_Struct_SC56)arg1 ;
-(id)samplerAtIndices:(SCD_Struct_SC56)arg1 ;
@end
