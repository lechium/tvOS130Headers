...
@interface SCNMTLRenderContext : NSObject <SCNBufferStream> {
	...
	SCD_Struct_SC55 _renderPassParameters;
	SCD_Struct_SC56 _currentStreamBufferIndices;
	...
	SCD_Struct_SC57* _processingContext;
	unsigned _seed;
	SCNSceneBuffer _frameUniforms[6];
	SCD_Struct_SC60 _sceneUniforms;
	SCD_Struct_SC61 _lightsData;
	SCD_Struct_SC63* _nodeUniforms;
	SCD_Struct_SC78* _lighting;
	Cache* _cache;
	SCD_Struct_SC80* _deferredRendering;
	SCD_Struct_SC81 _compositeRendering[2];
	SCNMTLRenderPipeline* _downSamplePipeline;
	SCD_Struct_SC82 _skCompositing;
	SCD_Struct_SC83 _debug;
	BOOL _showsAuthoringEnvironment;
	SCD_Struct_SC84 _compilationIssues;
	SCD_Struct_SC85 _counters;
	SCD_Struct_SC86* _renderGraph;
...
-(void)beginRenderPass:(id)arg1 renderEncoder:(void*)arg2 parameters:(SCD_Struct_SC55)arg3 ;
-(void)endRenderPass;
...
-(void)startProcessingRendererElementsWithEngineIterationContext:(SCD_Struct_SC88*)arg1 ;
...
-(void)drawWireframeOverlayForElements:(SCD_Struct_SC89*)arg1 range:(SCD_Struct_SC90)arg2 store:(C3DRendererElementStoreRef)arg3 passInstance:(_C3DFXPassInstance*)arg4 ;
...
-(void)processRendererElements:(SCD_Struct_SC89*)arg1 count:(unsigned)arg2 engineIterationContext:(SCD_Struct_SC88*)arg3 ;
