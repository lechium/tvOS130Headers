...
-(SCD_Struct_RP0*)playerViewController:(id)arg1 timeToSeekAfterUserNavigatedFromTime:(SCD_Struct_RP0)arg2 toTime:(SCD_Struct_RP0)arg3;
-(void)playerViewController:(id)arg1 willResumePlaybackAfterUserNavigatedFromTime:(SCD_Struct_RP0)arg2 toTime:(SCD_Struct_RP0)arg3;
