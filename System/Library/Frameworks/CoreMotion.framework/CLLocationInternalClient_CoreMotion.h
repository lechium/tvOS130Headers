...
-(unsigned char)getLocationForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 dynamicAccuracyReductionEnabled:(unsigned char)arg3 allowsAlteredAccessoryLocations:(unsigned char)arg4 location:(SCD_Struct_CL340*)arg5 ;
-(void)setMapMatchingRouteHint:(SCD_Struct_CL341*)arg1 count:(int)arg2 routingType:(int)arg3 ;
...
-(unsigned char)getGyroCalibrationDatabaseBiasFit:(SCD_Struct_CM333*)arg1 atTemperature:(float)arg2 ;
...
-(unsigned char)compassCalibrationDatabaseGetBias:(SCD_Struct_CL342*)arg1 magneticField:(SCD_Struct_CM1)arg2 acceleration:(SCD_Struct_CM1)arg3 ;
...
-(unsigned char)configure:(SCD_Struct_CL343)arg1 ;
