...
#import <DeviceLockScreenMessageExtension/NSExtensionRequestHandling.h>

@class NSString;

@interface DeviceLockScreenMessageRequestHandler : NSObject <NSExtensionRequestHandling>
