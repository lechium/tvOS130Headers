...
@property (assign,setter=_setUseDarkAppearance:,nonatomic) BOOL _useDarkAppearance; 
@property (assign,setter=_setUseElevatedUserInterfaceLevel:,nonatomic) BOOL _useElevatedUserInterfaceLevel; 
...
@property (assign,setter=_setUseSystemAppearance:,nonatomic) BOOL _useSystemAppearance; 
...
-(void)_setHostApplicationProcessIdentifier:(int)arg1 auditToken:(SCD_Struct_We68)arg2 ;
