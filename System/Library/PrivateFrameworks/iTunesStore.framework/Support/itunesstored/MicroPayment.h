...
@property (nonatomic,copy) NSString * originatingStorefront; 
...
@property (nonatomic,retain) NSString * discountIdentifier; 
@property (nonatomic,retain) NSString * discountKeyIdentifier; 
@property (nonatomic,retain) NSString * discountNonceString; 
@property (nonatomic,retain) NSString * discountSignature; 
@property (nonatomic,retain) NSNumber * discountTimestamp; 
