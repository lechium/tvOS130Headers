...
@class ML3MusicLibrary, ICConnectionConfiguration, NSURLSession, NSObject, CloudArtworkOperationQueue, NSMutableDictionary, NSString, MSVWatchdog;
...
-(void)cancelAllImportsAndWaitForOperationsToFinish:(BOOL)arg1 ;
