...
@interface PXCuratedLibrarySectionGeometryDescriptor : NSObject {
	...
	SCD_Struct_PX73 _headerCornerRadius;
	CGRect _sectionRect;
...
@property (nonatomic,readonly) SCD_Struct_PX74 headerCornerRadius;              //@synthesize headerCornerRadius=_headerCornerRadius - In the implementation block
...
-(id)init;
-(CGRect)sectionRect;
-(id)initWithSectionRect:(CGRect)arg1 headerRect:(CGRect)arg2 keyAssetRect:(CGRect)arg3 headerCornerRadius:(SCD_Struct_PX74)arg4 headerAsset:(id)arg5 ;
-(id)initWithSectionRect:(CGRect)arg1 headerRect:(CGRect)arg2 keyAssetRect:(CGRect)arg3 headerCornerRadius:(SCD_Struct_PX74)arg4 headerAsset:(id)arg5 visualPosition:(long long)arg6 ;
...
-(SCD_Struct_PX74)cornerRadiusForRect:(CGRect)arg1 ;
-(CGRect)keyAssetRect;
-(CGRect)headerRect;
-(SCD_Struct_PX74)headerCornerRadius;
