...
@interface UIStatusBar_Base : _UIScrollsToTopInitiatorView <UIStatusBarServerClient, UIStatusBarStateObserver> {
	...
	SCD_Struct_UI104* _localDataOverrides;
...
@property (nonatomic,readonly) SCD_Struct_UI104* localDataOverrides;                                                //@synthesize localDataOverrides=_localDataOverrides - In the implementation block
...
-(id)activeTintColor;
-(BOOL)_isTransparent;
-(void)setLocalDataOverrides:(SCD_Struct_UI104*)arg1 ;
...
-(SCD_Struct_UI104*)localDataOverrides;
