...
#import <ActionKit/WFOverlayImageEditorOptionsViewDelegate.h>

@class UIImage, NSArray, WFFileRepresentation, NSMapTable, WFOverlayImageEditorOptionsView, WFOverlayImageEditorCanvasView, WFOpacitySliderView, NSLayoutConstraint;
