...
-(NSURL *)destURL;
-(BOOL)onlyV1;
-(id)_iconDataForBundle:(CFBundleRef)arg1 isWatchBundle:(BOOL)arg2 error:(id*)arg3 ;
-(BOOL)_copyAppIconsFromBundle:(id)arg1 toPlaceholder:(id)arg2 isWatchBundle:(BOOL)arg3 ;
-(id)_wkBundleForAppContainer:(id)arg1 error:(id*)arg2 ;
-(void)setWatchKitAppBundleID:(NSString *)arg1 ;
-(BOOL)_createCompanionAppPlaceholderForApp:(id)arg1 error:(id*)arg2 ;
