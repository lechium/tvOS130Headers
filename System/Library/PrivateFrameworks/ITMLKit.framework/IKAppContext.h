...
#import <ITMLKit/IKAppCacheDelegate.h>
#import <ITMLKit/IKJSInspectorControllerDelegate.h>

@protocol OS_dispatch_source, IKApplication, IKAppContextDelegate, IKAppScriptFallbackHandler;
@class NSNumber, NSThread, IKJSArrayBufferStore, NSObject, JSContext, IKAppCache, NSString, NSMutableArray, NSError, IKAppReloadContext, NSURL, IKJSApplication, IKJSFoundation, IKJSWeakMap, IKJSViewModelService, IKViewElementRegistry, IKJSInspectorController;
