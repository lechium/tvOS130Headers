...
-(SCD_Struct_Ne25)_parseTimeIntoWeekdayAndSlotId:(long long)arg1 withReferenceDate:(id)arg2 ;
-(void)_processNetworkState:(SCD_Struct_Ne26*)arg1 toStateSet:(id)arg2 stateStartTimeInfo:(SCD_Struct_Ne25)arg3 stateEndTimeInfo:(SCD_Struct_Ne25)arg4 effectiveNetworkId:(id)arg5 ;
...
-(SCD_Struct_Ne27)_calculateStatisticsFromNetworkStateTable:(id)arg1 usingPredicate:(id)arg2 ;
