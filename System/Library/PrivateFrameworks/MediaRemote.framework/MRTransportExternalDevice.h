...
#import <MediaRemote/MRProtocolClientConnectionDelegate.h>
...
-(void)_handlePlaybackSessionMigrateRequest:(MRPlaybackSessionProtobuf*)arg1 request:(id)arg2 forPlayerPath:(MRNowPlayingPlayerPathProtobuf*)arg3 completion:(/*^block*/id)arg4 ;
