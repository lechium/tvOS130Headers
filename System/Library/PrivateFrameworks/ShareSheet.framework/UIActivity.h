...
@class _UIActivityResourceLoader, NSString, NSLocale, NSUUID, NSExtension, UIImage, UIViewController;
...
@property (nonatomic,retain) NSLocale * preferredLocale;                                              //@synthesize preferredLocale=_preferredLocale - In the implementation block
...
-(void)setPreferredLocale:(NSLocale *)arg1 ;
