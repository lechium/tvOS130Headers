...
-(BOOL)findSampleRectsWithInfo:(SCD_Struct_PA76*)arg1 screenColor:(int*)arg2 colorPrimaries:(int)arg3 width:(int)arg4 height:(int)arg5 minGreenHueAngle:(float)arg6 maxGreenHueAngle:(float)arg7 greenChroma:(float)arg8 minBlueHueAngle:(float)arg9 maxBlueHueAngle:(float)arg10 blueChroma:(float)arg11 histoPercentageIncluded:(float)arg12 omSamples:(OMSamples*)arg13 viewingSetupMatte:(BOOL)arg14 use32x32Histogram:(BOOL)arg15 simpleKey:(BOOL)arg16 ;
@end
