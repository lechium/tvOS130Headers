...
@interface IDSDAccountSendMessageContext : NSObject {
	...
	BOOL _serviceAllowLiveMessageDelivery;
...
@property (assign,nonatomic) BOOL serviceAllowLiveMessageDelivery;                            //@synthesize serviceAllowLiveMessageDelivery=_serviceAllowLiveMessageDelivery - In the implementation block
...
@property (assign,nonatomic) BOOL shouldAllowLiveMessageDelivery;                             //@synthesize shouldAllowLiveMessageDelivery=_shouldAllowLiveMessageDelivery - In the implementation block
...
-(void)setServiceAllowLiveMessageDelivery:(BOOL)arg1 ;
...
-(void)setShouldAllowLiveMessageDelivery:(BOOL)arg1 ;
