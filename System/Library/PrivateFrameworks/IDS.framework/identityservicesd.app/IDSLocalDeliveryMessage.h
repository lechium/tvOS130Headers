...
@property (assign,nonatomic) BOOL nonCloudWaking;                                             //@synthesize nonCloudWaking=_nonCloudWaking - In the implementation block
...
@property (assign,nonatomic) BOOL requireLocalWiFi;                                           //@synthesize requireLocalWiFi=_requireLocalWiFi - In the implementation block
