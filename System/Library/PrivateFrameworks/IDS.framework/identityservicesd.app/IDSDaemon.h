...
#import <identityservicesd/IDSRapportDeliveryControllerDelegate.h>
#import <identityservicesd/IDSPairingManagerDelegate.h>
#import <identityservicesd/IDSRegistrationHashProcessorDelegate.h>
...
+(BOOL)_topicAllowsNoEncryption:(id)arg1 fromIdentifier:(id)arg2 ;
...
-(BOOL)daemonInterface:(id)arg1 shouldGrantAccessForPID:(int)arg2 auditToken:(SCD_Struct_ID19)arg3 portName:(id)arg4 listenerConnection:(id)arg5 setupInfo:(id)arg6 setupResponse:(id*)arg7 ;
...
-(id)_lockedRemoteObjectsWithService:(id)arg1 entitlements:(id)arg2 command:(id)arg3 capabilities:(unsigned)arg4 ignoreService:(BOOL)arg5 useNotificationServices:(BOOL)arg6 ;
...
-(BOOL)_shouldLaunchClientForCapabilities:(unsigned)arg1 ;
...
-(BOOL)_canSendNonUrgentInternetMessageForTopic:(id)arg1 ;
...
-(BOOL)dropMessageIfDropPointIsDetectedWithSendParameters:(id)arg1 ;
-(BOOL)_canSendMessageWithAccount:(id)arg1 toDestination:(id)arg2 ;
...
-(void)_optionallyDecryptMessage:(id)arg1 encryptedData:(id)arg2 forGroupID:(id)arg3 forTopic:(id)arg4 fromID:(id)arg5 certifiedDeliveryContext:(id)arg6 isLiveRetry:(BOOL)arg7 completionBlock:(/*^block*/id)arg8 ;
-(void)_sendMessageCheckpointIfNecessary:(id)arg1 checkpoint:(long long)arg2 service:(id)arg3 ;
-(void)_submitLastResortCacheMetricForGUID:(id)arg1 service:(id)arg2 ;
-(BOOL)_shouldForgetCachedPeerTokensForDecryptionErrorType:(long long)arg1 withOriginalDecryptionError:(id)arg2 ;
-(BOOL)_shouldRetryForDecryptionErrorType:(long long)arg1 ;
-(double)_decryptionRetryIntervalForError:(id)arg1 ;
-(id)_failureReasonMessageFromECError:(id)arg1 andLegacyError:(id)arg2 ;
-(BOOL)_shouldReplyWithCertifiedDeliveryReceiptForDecryptionErrorType:(long long)arg1 ;
-(BOOL)_shouldReplyWithRemoteDecryptionErrorMessageForDecryptionErrorType:(long long)arg1 ;
...
-(BOOL)_shouldForgetCachedPeerTokensForIncomingRemoteDecryptionErrorType:(long long)arg1 ;
-(BOOL)_shouldDropMessageForIncomingErrorMessageWithDecryptionErrorType:(long long)arg1 ;
...
-(BOOL)_doesMessageContainValidCombination:(id)arg1 ;
-(id)_validAccountForIncomingMessageSentToIdentifier:(id)arg1 service:(id)arg2 filterMessage:(BOOL*)arg3 ;
...
-(BOOL)_isDeviceInAccountRegistration:(id)arg1 forService:(id)arg2 ;
-(BOOL)_processNonMessagingPayloadWithCommand:(id)arg1 dictionaryPayload:(id)arg2 senderToken:(id)arg3 topic:(id)arg4 toIdentifier:(id)arg5 fromID:(id)arg6 peerResponseIdentifier:(id)arg7 guid:(id)arg8 service:(id)arg9 shouldFilter:(BOOL)arg10 idsMessageContext:(id)arg11 messageContext:(id)arg12 ;
...
-(void)_processMessageError:(BOOL)arg1 topLevelMessage:(id)arg2 error:(id)arg3 messageID:(id)arg4 service:(id)arg5 serviceType:(id)arg6 token:(id)arg7 fromIdentifier:(id)arg8 toIdentifier:(id)arg9 groupID:(id)arg10 completionBlock:(/*^block*/id)arg11 ;
-(BOOL)_shouldDropMessageForIncomingDecryptionErrorType:(long long)arg1 ;
...
-(BOOL)_isBulkingStorageMessagesForService:(id)arg1 ;
...
-(void)updateMembers:(id)arg1 forGroup:(id)arg2 sessionID:(id)arg3 withContext:(id)arg4 triggeredLocally:(BOOL)arg5 messageContext:(id)arg6 ;
