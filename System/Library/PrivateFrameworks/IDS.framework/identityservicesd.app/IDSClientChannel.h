...
@property (assign,nonatomic) BOOL clientReady;                                  //@synthesize clientReady=_clientReady - In the implementation block
...
-(BOOL)writePacketBuffer:(SCD_Struct_ID4*)arg1 metaData:(const void*)arg2 metadataSize:(unsigned)arg3 moreComing:(BOOL)arg4 ;
-(BOOL)writeBuffer:(char*)arg1 bufferSize:(unsigned)arg2 metaData:(const void*)arg3 metadataSize:(unsigned)arg4 moreComing:(BOOL)arg5 ;
