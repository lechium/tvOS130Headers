...
-(void)fetchCloudChangesWithOptions:(id)arg1 xpcActivity:(id)arg2 completion:(/*^block*/id)arg3;
...
#import <HomeKitDaemon/HMBMirrorProtocol.h>

@protocol HMBLocalZoneID, OS_dispatch_queue, NAScheduler;
@class NAFuture, HMBLocalZone, NSMutableSet, HMDNetworkRouterFirewallRuleManagerBackingStoreMirrorInternalStateModel, HMBCloudDatabase, HMBLocalDatabase, NSObject, NAPromise, NSString;
...
@property (nonatomic,readonly) NSMutableSet * watchedRecordIDs;                                                                    //@synthesize watchedRecordIDs=_watchedRecordIDs - In the implementation block
