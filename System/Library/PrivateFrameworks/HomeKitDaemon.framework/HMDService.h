...
+(BOOL)processUpdateForCharacteristicType:(id)arg1 value:(id)arg2 serviceType:(id)arg3 service:(id)arg4 serviceTransactionGetter:(/*^block*/id)arg5 accessory:(id)arg6 accessoryTransaction:(id)arg7 accInfoChanged:(BOOL*)arg8 ;
