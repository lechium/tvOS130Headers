...
@class HMDBackingStore, HMDCloudLegacyZone, HMDCloudMetadataZone, HMDCloudHomeManagerZone, HMDCloudZone, NSMutableDictionary, NSObject, CKServerChangeToken;
...
@property (nonatomic,readonly) HMDCloudZone * homeDataInformation;                         //@synthesize homeDataInformation=_homeDataInformation - In the implementation block
...
-(BOOL)areAllServerChangeTokenValid;
@end
