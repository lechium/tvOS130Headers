...
@property (nonatomic,readonly) NSUnit * measurementUnit;                            //@synthesize measurementUnit=_measurementUnit - In the implementation block
