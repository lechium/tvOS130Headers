...
@class NSString, NSNumber, NSArray, NSUnit;
...
@property (nonatomic,copy) NSUnit * measurementUnit;                           //@synthesize measurementUnit=_measurementUnit - In the implementation block
...
-(void)setMeasurementUnit:(NSUnit *)arg1 ;
@end
