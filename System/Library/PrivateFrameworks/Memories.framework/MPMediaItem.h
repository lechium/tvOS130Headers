...
#import <Memories/WFSerializableContent.h>
#import <Memories/WFNaming.h>

@class NSString, NSArray, NSDate, MPMediaItemArtwork, NSURL;

@interface MPMediaItem : MPMediaEntity <WFSerializableContent, WFNaming>
