...
@class NSLocale, NSCharacterSet, CHRecognitionInsightRequest, CHRecognitionInsight, CHStrokeTransitionModel, CHCutpointModel, NSObject, CHPatternNetwork, CHRecognizerConfiguration, NSDictionary, NSMutableDictionary, CHSpellChecker, NSURL, CHDrawing, NSString, NSMutableIndexSet;
