...
@interface VCAudioTransmitter : NSObject <VCAudioIOSink, VCConnectionChangedHandler> {
	...
	SCD_Struct_VC156 _currentChannelMetrics;
	SCD_Struct_VC158 _idsChannelDataFormat;
...
@property (assign,nonatomic) SCD_Struct_VC156 currentChannelMetrics;                          //@synthesize currentChannelMetrics=_currentChannelMetrics - In the implementation block
...
-(SCD_Struct_VC156)currentChannelMetrics;
...
-(void)setCurrentChannelMetrics:(SCD_Struct_VC156)arg1 ;
@end
