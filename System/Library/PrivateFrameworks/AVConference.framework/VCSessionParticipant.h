...
#import <AVConference/VCMediaStreamDelegate.h>
...
#import <AVConference/VCAudioPowerSpectrumSourceDelegate.h>
...
-(void)collectVideoChannelMetrics:(SCD_Struct_VC156*)arg1 ;
-(void)collectAudioChannelMetrics:(SCD_Struct_VC156*)arg1 ;
