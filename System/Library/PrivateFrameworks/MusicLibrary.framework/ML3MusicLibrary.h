...
@property (assign,setter=icd_setSagaDatabaseUserVersion:,nonatomic) long long icd_sagaDatabaseUserVersion; 
@property (assign,setter=icd_setSagaCloudAddToPlaylistBehavior:,nonatomic) long long icd_sagaCloudAddToPlaylistBehavior; 
@property (assign,setter=icd_setPreferredVideoQuality:,nonatomic) long long icd_preferredVideoQuality; 
...
-(long long)icd_sagaDatabaseUserVersion;
-(void)icd_setSagaDatabaseUserVersion:(long long)arg1 ;
-(long long)icd_sagaCloudAddToPlaylistBehavior;
-(void)icd_setSagaCloudAddToPlaylistBehavior:(long long)arg1 ;
-(long long)icd_preferredVideoQuality;
-(void)icd_setPreferredVideoQuality:(long long)arg1 ;
