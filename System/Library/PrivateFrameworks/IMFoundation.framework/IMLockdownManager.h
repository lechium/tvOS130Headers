...
#import <identityservicesd/IDSPhoneNumberValidationStateMachineLockdownManager.h>

@class NSString;

@interface IMLockdownManager : NSObject <IDSPhoneNumberValidationStateMachineLockdownManager> {
