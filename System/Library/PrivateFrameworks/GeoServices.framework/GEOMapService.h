...
-(id)ticketForReverseGeocodeCoordinate:(SCD_Struct_GE33)arg1 includeEntryPoints:(BOOL)arg2 shiftLocationsIfNeeded:(BOOL)arg3 traits:(id)arg4 ;
-(id)ticketForReverseGeocodeCoordinate:(SCD_Struct_GE33)arg1 includeEntryPoints:(BOOL)arg2 shiftLocationsIfNeeded:(BOOL)arg3 preserveOriginalLocation:(BOOL)arg4 traits:(id)arg5 ;
-(id)_searchable_ticketForReverseGeocodeCoordinate:(SCD_Struct_GE33)arg1 includeEntryPoints:(BOOL)arg2 shiftLocationsIfNeeded:(BOOL)arg3 preserveOriginalLocation:(BOOL)arg4 traits:(id)arg5 ;
-(id)_searchable_ticketForReverseGeocodeCoordinate:(SCD_Struct_GE33)arg1 floor:(int)arg2 includeEntryPoints:(BOOL)arg3 shiftLocationsIfNeeded:(BOOL)arg4 preserveOriginalLocation:(BOOL)arg5 traits:(id)arg6 ;
-(id)ticketForReverseGeocodeCoordinate:(SCD_Struct_GE33)arg1 shiftLocationsIfNeeded:(BOOL)arg2 traits:(id)arg3 ;
...
-(id)ticketForReverseGeocodeCoordinate:(SCD_Struct_GE33)arg1 shiftLocationsIfNeeded:(BOOL)arg2 preserveOriginalLocation:(BOOL)arg3 traits:(id)arg4 ;
-(id)ticketForReverseGeocodeCoordinate:(SCD_Struct_GE33)arg1 includeETA:(BOOL)arg2 shiftLocationsIfNeeded:(BOOL)arg3 traits:(id)arg4 ;
-(id)ticketForReverseGeocodeCoordinate:(SCD_Struct_GE33)arg1 floor:(int)arg2 includeEntryPoints:(BOOL)arg3 shiftLocationsIfNeeded:(BOOL)arg4 preserveOriginalLocation:(BOOL)arg5 traits:(id)arg6 ;
...
-(id)ticketForPlaceRefinementRequestWithCoordinate:(SCD_Struct_GE33*)arg1 addressLine:(id)arg2 placeName:(id)arg3 traits:(id)arg4 ;
...
-(id)ticketForNearestTransitStation:(id)arg1 coordinate:(SCD_Struct_GE33)arg2 traits:(id)arg3 ;
