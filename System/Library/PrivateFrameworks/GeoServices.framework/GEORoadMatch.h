...
@interface GEORoadMatch : NSObject {
	...
	NSString* _roadName;
	SCD_Struct_GE33 _coordinateOnRoad;
...
@property (assign,nonatomic) SCD_Struct_GE33 coordinateOnRoad;              //@synthesize coordinateOnRoad=_coordinateOnRoad - In the implementation block
