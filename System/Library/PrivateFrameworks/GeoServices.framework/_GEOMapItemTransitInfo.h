...
-(NSArray *)systems;
-(id)initWithTransitInfo:(id)arg1 schedule:(id)arg2 timeZone:(id)arg3 incidents:(id)arg4 hasTransitIncidentComponent:(BOOL)arg5 incidentExpirationDate:(id)arg6 providerID:(int)arg7 coordinate:(SCD_Struct_GE33)arg8 transitStops:(id)arg9 composedRoute:(id)arg10 ;
-(NSArray *)labelItems;
