...
#import <GeoServices/GEONavigationServerListenerXPCInterface.h>
...
-(void)_notifyWithPositionFromSign:(SCD_Struct_GE33)arg1 ;
-(void)requestPositionFromManeuver;
-(void)_notifyWithPositionFromManeuver:(SCD_Struct_GE33)arg1 ;
-(void)requestPositionFromDestination;
-(void)_notifyWithPositionFromDestination:(SCD_Struct_GE33)arg1 ;
