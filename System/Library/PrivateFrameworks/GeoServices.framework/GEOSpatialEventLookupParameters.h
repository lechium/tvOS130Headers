...
-(NSArray *)categories;
-(int)maxResultCount;
-(id)initWithCoordinate:(SCD_Struct_GE33)arg1 radius:(double)arg2 categories:(id)arg3 dateInterval:(id)arg4 maxResultCount:(int)arg5 ;
-(id)initWithCoordinate:(SCD_Struct_GE33)arg1 radius:(double)arg2 categories:(id)arg3 dateInterval:(id)arg4 ;
