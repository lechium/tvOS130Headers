...
+(id)detailedTransitTileFinderForMap:(id)arg1 center:(SCD_Struct_GE33)arg2 radius:(double)arg3 ;
+(id)realisticTileFinderForMap:(id)arg1 center:(SCD_Struct_GE33)arg2 radius:(double)arg3 ;
+(id)buildingsTileFinderForMap:(id)arg1 center:(SCD_Struct_GE33)arg2 radius:(double)arg3 ;
+(id)transitGeometryTileFinderForMap:(id)arg1 center:(SCD_Struct_GE33)arg2 radius:(double)arg3 ;
-(void)dealloc;
-(void)cancel;
-(GEOMapAccess *)map;
-(int)tileSize;
...
-(id)_initWithMap:(id)arg1 zoomLevel:(unsigned long long)arg2 tileSize:(int)arg3 tileScale:(int)arg4 tileStyle:(int)arg5 center:(SCD_Struct_GE33)arg6 radius:(double)arg7 ;
