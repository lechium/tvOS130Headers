...
#import <GameCenterDashboardExtension/GKGameCenterDashboardServiceProtocol.h>

@class NSString, GKGame;

@interface GKDashboardExtensionContext : GKExtensionContext <GKGameCenterDashboardServiceProtocol>
