...
@property (nonatomic,retain) OBPrivacyFlow * privacyFlow;              //@synthesize privacyFlow=_privacyFlow - In the implementation block
...
-(void)setPrivacyFlow:(OBPrivacyFlow *)arg1 ;
@end
