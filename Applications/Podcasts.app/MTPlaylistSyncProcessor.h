...
@property (nonatomic,retain) NSMutableSet * addedPlaylists;              //@synthesize addedPlaylists=_addedPlaylists - In the implementation block
...
-(void)setAddedPlaylists:(NSMutableSet *)arg1 ;
@end
