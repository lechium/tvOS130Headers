...
#import <Podcasts/MTPlaybackIdentifierComposing.h>
...
-(MRSystemAppPlaybackQueueRef)playbackQueueWithAccountInfoForManifest:(id)arg1 queueStatus:(out unsigned long long*)arg2 ;
-(void)fetchPlayerItemsForPlaybackQueueRequestIdentifiers:(id)arg1 initiatedByAnotherUser:(BOOL)arg2 completion:(/*^block*/id)arg3 ;
-(MRSystemAppPlaybackQueueRef)playbackQueueWithAccountInfoForPlayerItems:(id)arg1 ;
...
-(void)fetchPlayerItemsForPlaybackQueueRequestIdentifiers:(id)arg1 completion:(/*^block*/id)arg2 ;
@end
