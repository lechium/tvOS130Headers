...
@class SATVDiagnosticsController, NSString;

@interface SATVDiagnosticsStep : NSObject <SATVBaseStep> {

	id<SATVStepDelegate> stepDelegate;
	SATVDiagnosticsController* _diagnosticsController;

}

@property (nonatomic,retain) SATVDiagnosticsController * diagnosticsController;              //@synthesize diagnosticsController=_diagnosticsController - In the implementation block
...
-(void)_presentDiagnosticsController;
-(SATVDiagnosticsController *)diagnosticsController;
-(void)setDiagnosticsController:(SATVDiagnosticsController *)arg1 ;
@end
