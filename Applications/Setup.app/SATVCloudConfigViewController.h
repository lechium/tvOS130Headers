...
-(void)consentViewControllerDidSelectFooter:(id)arg1 ;
-(void)consentViewControllerDidSelectAuxiliary:(id)arg1 ;
-(BOOL)consentViewControllerCanSelectDissent:(id)arg1 ;
...
-(void)_applyConfiguration:(BOOL)arg1 ;
-(id)_aboutText;
-(void)showLeaveRemoteManagementAlert;
-(void)_showEraseDeviceAlert;
-(void)_presentEraseAlertWithTitle:(id)arg1 message:(id)arg2 eraseHandler:(/*^block*/id)arg3 ;
