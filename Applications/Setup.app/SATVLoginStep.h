...
@class SATVLoginViewController, NSString;

@interface SATVLoginStep : NSObject <SATVBaseStep> {

	id<SATVStepDelegate> stepDelegate;
	SATVLoginViewController* _loginViewController;

}

@property (nonatomic,retain) SATVLoginViewController * loginViewController;              //@synthesize loginViewController=_loginViewController - In the implementation block
...
-(SATVLoginViewController *)loginViewController;
-(void)setLoginViewController:(SATVLoginViewController *)arg1 ;
@end
