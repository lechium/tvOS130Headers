...
#import <TVPhotos/MPAssetKeyDelegate.h>
#import <UIKit/UITableViewDataSource.h>
#import <UIKit/UITableViewDelegate.h>
#import <UIKit/UIGestureRecognizerDelegate.h>

@protocol OS_dispatch_source;
@class NSDictionary, TVPMarimbaView, UIVisualEffectView, UITableView, UIView, UIActivityIndicatorView, UITapGestureRecognizer, NSObject, NSArray, NSString, TVPSlideshowUtilities, NSTimer;
...
@interface TVPSlideshowMarimbaViewController : UIViewController <MPAssetKeyDelegate, UITableViewDataSource, UITableViewDelegate, UIGestureRecognizerDelegate> {
	...
	TVPSlideshowUtilities* _slideshowUtilites;
...
@property (nonatomic,retain) TVPMarimbaView * marimbaView;                                     //@synthesize marimbaView=_marimbaView - In the implementation block
...
@property (nonatomic,retain) TVPSlideshowUtilities * slideshowUtilites;                        //@synthesize slideshowUtilites=_slideshowUtilites - In the implementation block
...
-(void)setMarimbaView:(TVPMarimbaView *)arg1 ;
...
-(void)setSlideshowUtilites:(TVPSlideshowUtilities *)arg1 ;
...
-(void)immediatelyRefreshPhotoAssets:(id)arg1 ;
@end
