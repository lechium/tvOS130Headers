...
@protocol TVPOneupViewDelegate, TVPOneupViewDataSource;
...
@interface TVPOneupView : UIView <UIGestureRecognizerDelegate> {
	...
	id<TVPOneupViewDelegate> _delegate;
	id<TVPOneupViewDataSource> _dataSource;
...
@property (assign,nonatomic) id<TVPOneupViewDelegate> delegate;                                  //@synthesize delegate=_delegate - In the implementation block
@property (assign,nonatomic) id<TVPOneupViewDataSource> dataSource;                              //@synthesize dataSource=_dataSource - In the implementation block
...
-(id<TVPOneupViewDelegate>)delegate;
-(void)setDelegate:(id<TVPOneupViewDelegate>)arg1 ;
-(unsigned long long)currentMode;
-(unsigned long long)transition;
-(void)setCurrentMode:(unsigned long long)arg1 ;
-(id<TVPOneupViewDataSource>)dataSource;
-(void)setDataSource:(id<TVPOneupViewDataSource>)arg1 ;
-(void)reloadData;
