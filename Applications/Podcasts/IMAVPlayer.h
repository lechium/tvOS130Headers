...
@property (assign,nonatomic) SCD_Struct_IM22 delegateFlags;                                    //@synthesize delegateFlags=_delegateFlags - In the implementation block
...
-(void)setDelegateFlags:(SCD_Struct_IM22)arg1 ;
-(SCD_Struct_IM22)delegateFlags;
