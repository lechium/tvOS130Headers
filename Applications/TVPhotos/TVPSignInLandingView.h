...
@interface TVPSignInLandingView : UIView {
	...
	id<TVPSignInLandingViewDelegate> _delegate;
...
@property (assign,nonatomic,__weak) id<TVPSignInLandingViewDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
-(id<TVPSignInLandingViewDelegate>)delegate;
-(void)setDelegate:(id<TVPSignInLandingViewDelegate>)arg1 ;
-(NSString *)title;
