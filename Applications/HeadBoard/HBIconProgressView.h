...
@class _SBInstallProgressStateTransition, _HBIconProgressPausedTransition, _HBIconProgressFractionTransition, CADisplayLink, UIImage;

@interface HBIconProgressView : UIView {

	_SBInstallProgressStateTransition* _activeStateTransition;
	_HBIconProgressPausedTransition* _activePausedTransition;
	_HBIconProgressFractionTransition* _activeFractionTransition;
	...
	id<HBIconProgressViewDelegate> _delegate;
...
@property (assign,nonatomic) id<HBIconProgressViewDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)dealloc;
-(id<HBIconProgressViewDelegate>)delegate;
-(void)setDelegate:(id<HBIconProgressViewDelegate>)arg1 ;
