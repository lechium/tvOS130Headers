...
+(void)initialize;
+(BOOL)canInstallAppFromCloudRecord:(id)arg1 ;
+(void)uninstallApplicationsWithProxies:(id)arg1 ;
+(void)triggerAppInstallationForAppRecords:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
@end
