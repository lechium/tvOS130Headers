...
-(id)provisionedApplicationsInItems:(id)arg1 ;
-(id)applicationSetSortedByProvisioningOrder:(id)arg1 ;
-(id)tetherForApplication:(id)arg1 inProvisionedApplications:(id)arg2 ;
@end
