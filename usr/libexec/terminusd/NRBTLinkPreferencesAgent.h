...
@protocol OS_dispatch_queue, NRBTLinkPreferencesAgentDelegate;
...
@interface NRBTLinkPreferencesAgent : NSObject <NWNetworkAgent> {
	...
	id<NRBTLinkPreferencesAgentDelegate> _delegate;
...
@property (assign,nonatomic,__weak) id<NRBTLinkPreferencesAgentDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(id<NRBTLinkPreferencesAgentDelegate>)delegate;
-(void)setDelegate:(id<NRBTLinkPreferencesAgentDelegate>)arg1 ;
-(BOOL)isActive;
