...
@property (nonatomic,retain) SECC2MPError * networkFatalError;                                    //@synthesize networkFatalError=_networkFatalError - In the implementation block
...
-(void)setNetworkFatalError:(SECC2MPError *)arg1 ;
