...
@property (nonatomic,retain) SECC2MPError * errorValue;                 //@synthesize errorValue=_errorValue - In the implementation block
...
-(void)setErrorValue:(SECC2MPError *)arg1 ;
-(BOOL)hasErrorValue;
