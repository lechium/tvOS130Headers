...
@class NSSet, OTOperationDependencies, NSOperation;
...
@property (retain) NSSet * peerIDs;                                            //@synthesize peerIDs=_peerIDs - In the implementation block
...
-(id)initWithDependencies:(id)arg1 intendedState:(NSString*)arg2 errorState:(NSString*)arg3 peerIDs:(id)arg4 ;
-(void)setPeerIDs:(NSSet *)arg1 ;
