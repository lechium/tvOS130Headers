...
@interface DMDEngineSetDeclarationsOperation : DMDEngineDatabaseOperation {
	...
	DMFSetDeclarationsRequest* _request;

}

@property (nonatomic,retain) DMFSetDeclarationsRequest * request;              //@synthesize request=_request - In the implementation block
-(DMFSetDeclarationsRequest *)request;
-(void)setRequest:(DMFSetDeclarationsRequest *)arg1 ;
