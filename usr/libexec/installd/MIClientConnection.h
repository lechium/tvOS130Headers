...
#import <installd/MobileInstallerProtocol.h>
...
@property (nonatomic,readonly) unsigned percentComplete;                          //@synthesize percentComplete=_percentComplete - In the implementation block
...
-(void)sendProgressWithStatus:(id)arg1 percentComplete:(unsigned)arg2 ;
-(void)sendDelegateMessagesComplete;
-(void)_callBlockAfterDelegateMessagesSend:(/*^block*/id)arg1 ;
-(void)_doInstallationForURL:(id)arg1 withOptions:(id)arg2 completion:(/*^block*/id)arg3 ;
