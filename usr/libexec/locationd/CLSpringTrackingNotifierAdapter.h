...
#import <locationd/CLSpringTrackingNotifierProtocol.h>
...
-(CLSpringTrackingNotifier*)adaptee;
-(BOOL)syncgetIsTracking;
-(int)syncgetStartTracking;
-(int)syncgetStopTracking;
-(void)querySinceRecord:(CLSpringTrackerEntry)arg1 withReply:(/*^block*/id)arg2 ;
@end
