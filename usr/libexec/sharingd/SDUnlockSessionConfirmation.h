...
@property (assign,nonatomic) BOOL hasSupportsACK; 
@property (assign,nonatomic) BOOL supportsACK;                 //@synthesize supportsACK=_supportsACK - In the implementation block
...
-(BOOL)hasSupportsACK;
-(BOOL)supportsACK;
-(void)setSupportsACK:(BOOL)arg1 ;
-(void)setHasSupportsACK:(BOOL)arg1 ;
@end
